...
<body>
    ...
    <div class="card">
        <br>
        <h2>Isilah form login ini</h2>
        <img src="img form.jpg" width="440px" height="125px" class="img1">
        <p>Username :</p>
        ...
        <br>
        <br>
        <a href="index2.php" class="link">Klik disini apabila Anda belum Register</a>
